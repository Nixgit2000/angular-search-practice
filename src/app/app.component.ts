...
export class AppComponent {
  ...
  data = [
    ...
    {title: "Harry Potter", title2: "and the Deathly Hallows: Part I", font: "HP", fontSize: "1.7vw",fontSize2: "1.2vw", actor: "Daniel Radcliffe, Emma Watson, Rupert Grint, Alan Rickman, Tom Felton, Maggie Smith, Robbie Coltrane, Harry Melling", backgroundPos: "10% 90%",  pic: "https://www.peacocktv.com/dam/growth/assets/seo/HarryPotter/DH1/hp-dh1-desktop-min.jpg"},
